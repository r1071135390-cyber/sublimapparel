...
export const metadata = buildPageMetadata({
    ...
    "custom apparel examples",
    "B2B apparel portfolio",
    "sublimation projects",
    "custom clothing case studies",
    "apparel manufacturing portfolio",
    "Yiwu factory work",
    "custom apparel clients",
    "custom apparel case studies",
    "apparel manufacturer portfolio",
    "B2B apparel case studies",
    "all-over print case studies",
    "apparel factory projects",
    "team apparel case studies",
    "event apparel case studies",
    "corporate apparel case studies",
    "custom clothing portfolio",
    "sublimation portfolio",
    "B2B clothing portfolio",
    "apparel manufacturer projects",
    "apparel success stories",
    "custom apparel projects",
    "all-over print portfolio",
    "apparel brand portfolio",
    "sports apparel case studies",
    "race apparel case studies",
    "music festival apparel portfolio",
    "apparel collaboration examples",
    "apparel client work",
    "apparel manufacturing case studies",
    "factory project case studies",
    "MOQ 50 case studies",
    "DDP case studies",
    "Yiwu factory case studies",
    "school apparel case studies",
    "promotional apparel case studies",
    "private label case studies",
    "private label clothing case studies",
    "bulk apparel case studies",
    "wholesale apparel case studies",
