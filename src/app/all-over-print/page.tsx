...
export const metadata = buildPageMetadata({
    ...
    "full coverage print apparel",
    "all-over print manufacturer",
    "all-over print factory",
    "all-over print hoodies",
    "all-over print jerseys",
    "all-over print sublimation",
    "cut and sew all-over print",
    "seam to seam print apparel",
    "all-over print polyester",
    "all-over print cotton",
    "all-over print China factory",
    "bulk all-over print",
    "custom all-over print",
    "all-over print streetwear",
    "all-over print team uniforms",
    "all-over print for ecommerce",
    "all-over print startup",
    "all-over print fashion brand",
    "all-over print sportswear",
    "all-over print B2B",
    "all-over print wholesale",
    "edge-to-edge print apparel",
    "full-coverage print apparel",
    "all-over sublimation",
    "cut-and-sew all-over print",
    "all-over print sublimation apparel",
    "all-over print 100% cotton",
    "all-over print MOQ 50",
    "all-over print factory direct",
    "all-over print DDP shipping",
    "all-over print catalog",
    "all-over print no setup fees",
    "all-over print custom design",
    "all-over print small business",
    "all-over print startup apparel",
    "all-over print unlimited colors",
  ],
    alternates: {
