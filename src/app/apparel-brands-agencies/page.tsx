...
export default function ForBrandsPage() {
  const pageUrl = `${SITE_URL}/apparel-brands-agencies/`;
  const pageGraph = {
    ...
    "@graph": [
      // BreadcrumbList
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "Private Label & OEM Apparel Manufacturing", item: pageUrl },
        ],
      },
      // WebPage
      {
        ...
        "@id": `${pageUrl}#webpage`,
        url: pageUrl,
        name: "Private Label Apparel Manufacturer | Custom Production",
        description: "Private label apparel manufacturer and custom clothing production partner for growing brands and creative agencies. Custom labels, hang tags, retail...",
  ...
  return (
    <>
      ...
      {/* 2026-09-13 (R60): unified 3-channel CTA. Sits between the
          FAQ section and the full <Contact /> form so apparel brands
          & agencies visitors see the same quote-modal / WhatsApp /
          contact-form pattern used on every other high-intent B2B
          page. */}
      <UnifiedContactCta
        variant="full"
        sourceLabel="Apparel brands & agencies"
