...
export const metadata: Metadata = buildPageMetadata({
  ...
  keywords: [
    ...
    "sublimation UK",
    "Yiwu to UK",
    "UK post-Brexit duty apparel",
    "UK import duty clothing",
    "UK VAT apparel import",
    "UK apparel manufacturer",
    "UK clothing supplier",
    "UK custom apparel",
    "China to UK bulk shipping",
    "UK e-commerce apparel",
    "UK private label apparel",
    "UK apparel wholesale",
    "UK apparel dropshipping",
    "UK clothing import",
    "Yiwu to UK delivery",
    "UK apparel factory direct",
    "UK B2B apparel",
    "UK clothing manufacturer",
    "UK sublimation factory",
    "UK team apparel supplier",
    "UK sportswear manufacturer",
    "UK workwear supplier",
  ],
