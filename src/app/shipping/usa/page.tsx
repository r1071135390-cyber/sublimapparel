...
export const metadata: Metadata = buildPageMetadata({
  ...
  keywords: [
    ...
    "US clothing supplier",
    "China to US bulk shipping",
    "US import clothing",
    "Yiwu to US delivery",
    "US bulk apparel",
    "US-based clothing factory",
    "US apparel wholesale",
    "US custom apparel",
    "US e-commerce apparel",
    "US dropship clothing",
    "US private label apparel",
    "US apparel logistics",
    "China to US customs",
    "US apparel import duty",
    "US clothing factory direct",
    "Yiwu to USA shipping",
  ],
