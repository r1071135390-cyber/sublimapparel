...
export const metadata = buildPageMetadata({
    ...
    "customs cleared apparel",
    "DDP from China",
    "Section 301 tariff apparel",
    "US import duty clothing",
    "no surprise duties",
    "bulk shipping China",
    "B2B shipping from China",
    "apparel logistics",
    "customs broker apparel",
    "import duty paid",
    "tariff included shipping",
    "factory direct global delivery",
    "100+ countries shipping",
    "DDP shipping apparel",
    "delivered duty paid shipping",
    "international apparel shipping",
    "customs cleared apparel shipping",
    "landed cost shipping apparel",
    "no surprise duties shipping",
    "bulk shipping from China",
    "B2B shipping apparel",
    "apparel logistics China",
    "import duty paid shipping",
    "100+ countries shipping apparel",
  ],
    other: {
