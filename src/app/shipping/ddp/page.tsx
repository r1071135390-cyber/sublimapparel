...
export const metadata = buildPageMetadata({
    ...
    "DDP to Australia",
    "DDP to Canada",
    "DDP apparel manufacturer",
    "DDP customs clearance",
    "DDP duty paid",
    "DDP last-mile delivery",
    "DDP bulk shipping",
    "DDP clothing import",
    "DDP B2B shipping",
    "no surprise customs fees",
    "DDP for small business",
    "DDP for Amazon FBA",
    "DDP for Shopify brands",
    "delivered duty paid clothing",
    "DDP textile shipping",
    "Yiwu DDP shipping",
    "overseas warehouse DDP",
    "global shipping apparel DDP",
    "DDP duty paid shipping",
  ],
  });
