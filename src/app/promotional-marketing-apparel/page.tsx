...
export const metadata = buildPageMetadata({
    ...
    "promo products supplier",
    "branded merchandise manufacturer",
    "custom promotional products",
    "company swag bulk",
    "promotional t-shirt manufacturer",
    "giveaway shirts bulk",
    "branded apparel production",
    "marketing merchandise",
    "promo apparel supplier",
    "swag items bulk",
    "branded giveaways",
    "promotional clothing",
    "corporate swag packs",
    "custom branded apparel",
    "promotional marketing apparel",
    "promotional products apparel",
    "promo apparel manufacturer",
    "promotional clothing manufacturer",
    "promotional clothing supplier",
    "marketing merchandise apparel",
    "branded merchandise apparel",
    "corporate gift apparel",
    "swag apparel manufacturer",
    "swag clothing supplier",
    "B2B promotional apparel",
    "promotional campaign apparel",
    "marketing campaign apparel",
    "tradeshow apparel",
    "event promo apparel",
    "company swag apparel",
    "company merchandise apparel",
...
export default function CustomEventTShirtsPage() {
  ...
  return (
    <main className="min-h-screen bg-white text-neutral-900">
      ...
      <RelatedProducts solutionSlug="promotional-marketing-apparel" />
      ...
      {/* 2026-09-13 (R60): unified 3-channel CTA. Sits between the
          FAQ section and the full <Contact /> form so promotional &
          marketing apparel visitors see the same quote-modal /
          WhatsApp / contact-form pattern used on every other
          high-intent B2B page. */}
      <UnifiedContactCta
        variant="full"
        sourceLabel="Promotional & marketing apparel"
