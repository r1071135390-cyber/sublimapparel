...
export const metadata = buildPageMetadata({
    ...
    "case studies custom apparel",
    "SublimApparel case studies",
    "custom apparel project examples",
    "B2B apparel success stories",
    "race apparel case study",
    "event apparel case study",
    "corporate apparel case study",
    "sports team apparel case study",
    "school apparel case study",
    "promotional apparel case study",
    "private label case study",
    "team uniform case study",
    "festival merchandise case study",
    "marathon apparel case study",
    "cycling team case study",
    "esports jersey case study",
    "golf apparel case study",
    "breweries apparel case study",
    "music festival case study",
    "charity event case study",
    "youth camp apparel case study",
    "spirit wear case study",
    "custom apparel portfolio",
    "B2B apparel testimonials",
  ],
  });
...
export default function CasesPage() {
  ...
  const casesGraph = buildAboutSubPageGraph({
    subPage: "cases",
    ...
    breadcrumb: [{ name: "Case Studies", path: "/about/cases/" }],
    faq: faqs,
  });
      ...
      <section className="border-b-2 border-[#0a0a0a] bg-[#0a0a0a] text-[#faf9f6]">
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row">
            <Link href="/cases/" className="inline-flex items-center justify-center gap-2 border-2 border-[#ff4d00] bg-[#ff4d00] px-8 py-4 text-base font-bold uppercase tracking-wide text-black transition-colors hover:bg-[#e64400] hover:border-[#e64400]">
              See case studies →
            </Link>
      ...
      <section className="bg-[#0a0a0a] text-[#faf9f6]">
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          ...
          <div className="mt-12 flex flex-col gap-3 sm:flex-row">
            <RequestQuoteLink label="Cases / page / Get a quote" className="inline-flex items-center justify-center gap-2 border-2 border-[#ff4d00] bg-[#ff4d00] px-8 py-4 text-base font-bold uppercase tracking-wide text-black transition-colors hover:bg-[#e64400] hover:border-[#e64400]">Start a project →</RequestQuoteLink>
