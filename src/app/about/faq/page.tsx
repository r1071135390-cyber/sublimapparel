...
export const metadata = buildPageMetadata({
    ...
    "MOQ questions apparel",
    "DDP shipping FAQ",
    "sublimation process questions",
    "China apparel factory FAQ",
    "custom clothing FAQ",
    "apparel production FAQ",
    "all-over print FAQ",
    "DTG printing FAQ",
    "DTF printing FAQ",
    "bulk apparel FAQ",
    ...
    "B2B apparel FAQ",
    "factory direct FAQ",
    "sublimation cost FAQ",
    "sublimation quality FAQ",
    "apparel lead time FAQ",
    "custom apparel quote FAQ",
    "apparel import FAQ",
    "Yiwu factory FAQ",
    "apparel sample FAQ",
    "sublimation vs screen print FAQ",
    "SublimApparel FAQ",
    "custom apparel frequently asked",
    "MOQ 50 frequently asked",
    "sublimation order FAQ",
    "production timeline FAQ",
    "sample order FAQ",
    "payment methods apparel",
    "shipping methods apparel",
    "quality control FAQ",
...
const sections = [
  {
    ...
    questions: [
      ...
      { q: "What's the minimum order quantity (MOQ)?", a: "Per style: 50 pieces sublimation, 50 pieces mixed. Per order: 50 pieces across any styles. For samples, 1-3 pieces at $35-65 freight via DHL." },
  ...
  },
  {
    ...
    questions: [
      { q: "Can you do all-over printing on 100% cotton?", a: "Yes — via our allover digital print on cotton process. We print the full cotton fabric in a single edge-to-edge pass before cut-and-sew, so the design runs seam-to-seam with only the stitch lines as interruption. This is a different process from DTG and DTF (which are A4–A3 per panel, with visible panel seams). Allover digital print on cotton gives the same look as polyester sublimation, on 100% cotton substrate. MOQ is 50 pcs per design, lead time 20–25 days. See /fabric/cotton for the full process." },
      ...
      <section className="bg-[#0a0a0a] text-[#faf9f6]">
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          ...
          <div className="mt-12 flex flex-col gap-3 sm:flex-row">
            ...
            <RequestQuoteLink label="faq / page / Get a quote" className="inline-flex items-center justify-center gap-2 border-2 border-[#faf9f6] px-8 py-4 text-base font-bold uppercase tracking-wide text-[#faf9f6] transition-colors hover:bg-[#faf9f6] hover:text-[#0a0a0a]">Send a brief →</RequestQuoteLink>
          </div>
        </div>
      </section>
