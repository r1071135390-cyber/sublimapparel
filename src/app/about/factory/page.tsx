...
export const metadata = buildPageMetadata({
    ...
    "Yiwu clothing factory",
    "sublimation factory direct",
    "in-house production",
    "factory direct pricing",
    "Chinese garment factory",
    "apparel manufacturing plant",
    "Yiwu production facility",
    "custom apparel factory China",
    "B2B apparel factory",
    "factory-direct apparel",
    "manufacturer-direct clothing",
    "12 production lines apparel",
    "apparel factory capacity",
    "Yiwu factory visit",
    "OEM apparel factory",
    "ODM apparel factory",
    "sublimation production line",
    "apparel factory wholesale",
    "China clothing manufacturer factory",
    "apparel factory quality control",
    "Yiwu apparel factory tour",
    "factory visit SublimApparel",
    "12 production lines factory",
    "in-house apparel production",
    "OEM apparel factory China",
    "factory capacity 2500 daily",
    "trusted apparel factory",
    "established China factory",
    "sublimation manufacturing",
    "apparel production China",
  ],
  });
