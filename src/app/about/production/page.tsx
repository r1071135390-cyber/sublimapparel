...
export const metadata = buildPageMetadata({
    ...
    "production lead time apparel",
    "sublimation printing process",
    "apparel sample production",
    "production capacity apparel",
    "bulk apparel production",
    "production management apparel",
    "apparel factory production",
    "apparel manufacturing workflow",
    "sublimation production line",
    "production MOQ apparel",
    "custom garment production",
    "apparel production steps",
    "production scheduling apparel",
    "apparel manufacturing timeline",
    "fast turnaround apparel production",
    "15-25 day production time",
    "production timeline custom clothing",
    "production capacity 2500 daily",
    "production MOQ 50",
    "production steps explained",
    "production stages apparel",
    "production quality checks",
    "production delivery time",
    "production turnaround time",
    "production workflow B2B",
    "production quote process",
...
export default function ProductionPage() {
  ...
  // page imported buildBreadcrumbJsonLd but called buildFaqJsonLd
  // which was never imported — would fail production build.
  const productionGraph = buildAboutSubPageGraph({
    subPage: "production",
    name: "Production Process · 7 Steps from Inquiry to Delivery | SublimApparel",
    description:
      "Our 7-step production process: inquiry, quote, mockup, sample, bulk production, QC, shipping. 21-day average lead time from PO to delivery. Sublimation apparel from Yiwu.",
    breadcrumb: [{ name: "Production", path: "/about/production/" }],
    faq: faqs,
  });
