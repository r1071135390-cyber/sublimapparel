    ...
    <main className="min-h-screen bg-[#faf9f6] text-[#0a0a0a]">
      ...
      <section className="border-b-2 border-[#0a0a0a] bg-[#0a0a0a] text-[#faf9f6]">
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          ...
          <h1 className="max-w-4xl text-5xl font-extrabold leading-[0.95] tracking-tight md:text-7xl">
            ...
            <span className="block text-[#ff4d00]">50+ checkpoints.</span>
      ...
      <section className="border-b-2 border-[#0a0a0a]">
        <div className="mx-auto max-w-4xl px-6 py-16 md:py-24">
          <div className="text-xs font-mono uppercase tracking-widest text-[#ff4d00]">[ Why 4 stages ]</div>
          <h2 className="mt-3 text-3xl font-extrabold leading-tight md:text-5xl">
            Catching a defect at stage 1 costs $0.50.{" "}
            <span className="text-[#ff4d00]">At stage 4 it costs $15.</span>
          </h2>
      ...
      <section className="border-b-2 border-[#0a0a0a] bg-[#1a1a1a] text-[#faf9f6]">
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          <div className="mb-12 max-w-3xl">
            <div className="text-xs font-mono uppercase tracking-widest text-[#00c2ff]">[ 012.A / The 4 stages ]</div>
      ...
      <section className="border-b-2 border-[#0a0a0a]">
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-24">
          <div className="text-xs font-mono uppercase tracking-widest text-[#ff4d00]">[ 012.B / What we actually check ]</div>
      ...
      <section className="border-b-2 border-[#0a0a0a] bg-[#faf9f6]">
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          <div className="mb-12 max-w-3xl">
            <div className="text-xs font-mono uppercase tracking-widest text-[#ff4d00]">[ 012.C / Where it matters ]</div>
      ...
      <section className="border-b-2 border-[#0a0a0a]">
        <div className="mx-auto max-w-4xl px-6 py-16 md:py-24">
          <div className="text-xs font-mono uppercase tracking-widest text-[#ff4d00]">[ 012.D / FAQ ]</div>
      ...
      <section className="bg-[#0a0a0a] text-[#faf9f6]">
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          <div className="mb-8 text-xs font-mono uppercase tracking-widest text-[#ff4d00]">[ 012.E / Audit us ]</div>
