...
export const metadata = buildPageMetadata({
    ...
    "sports team apparel manufacturer service",
    "club kit production",
    "league uniform service",
    "custom team sportswear production",
    "team sports apparel production",
    "custom team jerseys",
    "custom team sportswear",
    "roster-locked sublimation",
    "team uniform manufacturer",
    "sports team apparel service",
    "athletic team apparel",
    "team jersey production",
    "league kit supplier",
    "club uniform bulk",
    "sports team merch",
    ...
    "team sportswear supplier",
    "team sublimation apparel",
    "team all-over print apparel",
    "team uniform factory",
    "sports club apparel",
    "sports league apparel",
    "sports team clothing",
    "sports club clothing",
    "sports league clothing",
    "sports team uniform factory",
  ],
  ...
  return (
    <main className="min-h-screen bg-white text-neutral-900">
      ...
      {/* 2026-09-13 (R60): unified 3-channel CTA. Sits between the
          FAQ section and the full <Contact /> form so team & sports
          apparel visitors see the same quote-modal / WhatsApp /
          contact-form pattern used on every other high-intent B2B
          page. */}
      <UnifiedContactCta
        variant="full"
        sourceLabel="Team & sports apparel"
