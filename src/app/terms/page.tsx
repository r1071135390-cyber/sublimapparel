...
export const metadata = buildPageMetadata({
  ...
  keywords: [
    ...
    "B2B apparel terms",
    "sublimation service terms",
    "all-over print terms",
    "factory terms apparel",
    "apparel manufacturer terms",
    "sublimation terms service",
    "custom clothing terms",
    "B2B clothing terms",
    "wholesale apparel terms",
    "factory direct terms",
    "apparel order terms",
    "apparel production terms",
    "apparel payment terms",
    "apparel shipping terms",
    "apparel RFQ terms",
    "sublimation quote terms",
    "MOQ terms apparel",
    "apparel manufacturer agreement",
    "apparel wholesale terms",
    "custom apparel T&C",
    "factory direct terms service",
    "sublimation factory terms",
    "apparel import terms",
    "SublimApparel terms",
    "MOQ 50 terms",
    "DDP terms apparel",
    "bulk apparel terms",
    "apparel manufacturing terms",
    "team apparel terms",
    "event apparel terms",
    "corporate apparel terms",
    "private label terms",
    "private label clothing terms",
    "apparel refund terms",
    "apparel cancellation terms",
    "apparel dispute terms",
    "apparel warranty terms",
    "apparel liability terms",
  ]
});
