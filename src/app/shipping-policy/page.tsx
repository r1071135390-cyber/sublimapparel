...
export const metadata = buildPageMetadata({
  ...
  keywords: [
    "shipping policy apparel",
    "apparel shipping terms",
    "DDP shipping terms",
    "apparel delivery policy",
    "custom apparel shipping",
    "bulk apparel shipping",
    "China apparel shipping policy",
    "factory direct shipping policy",
    "sublimation shipping policy",
    "all-over print shipping policy",
    "apparel order shipping",
    "Yiwu shipping policy",
    "apparel manufacturer shipping",
    "B2B shipping policy",
    "wholesale apparel shipping",
    "DDP apparel shipping terms",
    "apparel delivery terms",
    "shipping lead time apparel",
    "shipping fee apparel",
    "custom clothing shipping",
    "apparel import shipping policy",
    "factory shipping policy",
    "apparel bulk shipping terms",
    "DDP shipping delivery policy",
    "apparel shipping policy",
    "DDP shipping policy",
    "international shipping policy",
    "bulk apparel shipping policy",
    "apparel shipping timeline",
    "apparel shipping methods",
    "apparel shipping rates",
    "apparel shipping zones",
    "apparel shipping to USA",
    "apparel shipping to UK",
    "apparel shipping to EU",
    "apparel shipping to Australia",
    "apparel shipping to Canada",
    "apparel tracking policy",
    "apparel insurance policy",
    "apparel shipping damage policy",
    "apparel return shipping",
    "apparel lost package policy",
  ]
});
