...
export const metadata = buildPageMetadata({
    ...
    "bulk apparel quote",
    "all-over print quote",
    "team apparel quote",
    "event apparel quote",
    "corporate apparel quote",
    "factory direct quote",
    "custom t-shirt quote",
    "custom jersey quote",
    "custom hoodie quote",
    "sublimation quote MOQ 50",
    "B2B apparel quote",
    "wholesale apparel quote",
    "instant apparel quote",
    "apparel quote 24 hours",
    "factory quote sublimation",
    "China factory quote",
    "Yiwu factory quote",
    "DDP apparel quote",
    "rush apparel quote",
    "MOQ 50 quote apparel",
    "get apparel quote",
    "custom apparel quote request",
    "MOQ 50 quote",
    "DDP shipping quote",
    "custom clothing quote",
    "team uniform quote",
    "school apparel quote",
    "race apparel quote",
    "promotional apparel quote",
    "private label quote",
    "private label clothing quote",
    "small batch apparel quote",
    "custom sportswear quote",
    "sublimated t-shirt quote",
    "sublimated jersey quote",
    "sublimated hoodie quote",
  ],
  });
