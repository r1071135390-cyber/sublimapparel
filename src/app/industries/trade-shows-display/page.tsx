...
const data: CustomerProfileData = {
  ...
  keywords: [
    ...
    "booth shirts",
    "trade show apparel",
    "trade show booth apparel",
    "exhibit staff shirts",
    "custom trade show merchandise",
    "trade show giveaways",
    "display booth apparel",
    "trade show uniforms",
    "expo apparel",
    "convention apparel",
    "trade show swag",
    ...
    "expo merchandise",
    "custom exhibit apparel",
    "conference booth shirts",
    "trade show staff uniforms",
    "event display apparel",
    "exhibit hall shirts",
    "trade show polos",
    "trade show hoodies",
    "expo staff apparel",
    "custom trade show apparel",
    "booth staff shirts",
    "trade show branded apparel",
  ],
...
export default function Page() {
  return (
    <>
      <PageGeoAnswerBlock path="/industries/trade-shows-display/" />
