...
const collectionId = `${industriesUrl}#collection`;
const breadcrumbId = `${industriesUrl}#breadcrumb`;
const faqId = `${industriesUrl}#faq`;
...
export const metadata: Metadata = buildPageMetadata({
  ...
  keywords: [
    ...
    "industry-specific apparel manufacturer",
    "vertical apparel supplier",
    "B2B apparel by industry",
    "custom uniforms by industry",
    ...
    "race apparel manufacturer",
    "festival apparel manufacturer",
    "team uniform factory",
    "company apparel supplier",
    "spirit wear manufacturer",
    "breweries apparel supplier",
    "music merchandise manufacturer",
    "political campaign apparel",
    "endurance race apparel",
    "hospitality apparel supplier",
    "trade show apparel",
    "Greek life apparel",
    "summit apparel manufacturer",
    "industry custom clothing",
  ],
});
...
// R43: single @graph — BreadcrumbList + CollectionPage/ItemList + FAQPage
...
const industriesFaqs = [
  ...
  },
  {
    ...
    a: "MOQ is 50 pieces per design for cut-and-sew sublimation on polyester, and 30 pieces per design for re-orders. For DTG on 100% cotton, MOQ is 30 pieces per design. For sample / trial runs we can do 5–10 pieces with a 7–10 day turnaround.",
  },
  {
...
const industriesGraph = {
  ...
  "@graph": [
    ...
    // 2 · CollectionPage + ItemList (12 industry verticals)
    {
      "@type": "CollectionPage",
      "@id": collectionId,
      url: industriesUrl,
    ...
    // 3 · FAQPage
    {
      ...
      "@type": "FAQPage",
      "@id": faqId,
      mainEntity: industriesFaqs.map((it) => ({
        "@type": "Question",
        name: it.q,
