...
export default function Page() {
  return (
    <>
      {/* 2026-09-18 (R73 GEO): Direct Answer block above the
          CustomerProfilePage client template so AI engines see
          the question + answer before the dynamic content. */}
      <PageGeoAnswerBlock path="/industries/sports-teams-leagues/" />
