...
export const metadata: Metadata = buildPageMetadata({
  ...
  keywords: [
    ...
    "apparel manufacturing calendar",
    "bulk apparel production",
    "sublimation factory schedule",
    "apparel production timeline",
    "fast turnaround custom apparel",
    "apparel manufacturing capacity",
    "production planning custom apparel",
    "deadline driven production",
    "lead time clothing manufacturer",
