...
export const metadata = buildPageMetadata({
  ...
  keywords: [
    ...
    "China factory direct contact",
    "Yiwu apparel supplier WhatsApp",
    "China clothing factory contact",
    "custom apparel factory WhatsApp",
    "MOQ 50 factory direct",
    "DDP shipping factory direct",
    "Yiwu sublimation factory",
    "apparel factory direct quote",
    "WhatsApp factory China",
    "China factory WhatsApp contact",
    "Yiwu supplier WhatsApp",
    "WhatsApp apparel manufacturer",
    "WhatsApp sublimation factory",
    "direct WhatsApp factory",
    "Yiwu factory direct",
    "WhatsApp B2B factory",
    "factory WhatsApp bulk order",
    "Yiwu WhatsApp quote",
    "Chinese factory WhatsApp",
    "WhatsApp custom apparel factory",
    "WhatsApp clothing manufacturer",
    "WhatsApp all-over print factory",
    "Yiwu factory direct WhatsApp",
    "WhatsApp team apparel factory",
    "WhatsApp event apparel factory",
    "Yiwu supplier contact",
    "Chinese supplier WhatsApp",
    "WhatsApp DDP factory",
    "WhatsApp +86 198 1793 0190",
    "Yiwu factory quote WhatsApp",
    "WhatsApp Yiwu manufacturer",
    "WhatsApp Yiwu supplier",
    "direct WhatsApp factory contact",
    "factory WhatsApp number",
    "WhatsApp B2B apparel",
    "WhatsApp custom clothing",
    "WhatsApp MOQ 50 quote",
    "WhatsApp DDP quote",
    "WhatsApp bulk apparel",
    "WhatsApp team apparel",
    "WhatsApp event apparel",
    "WhatsApp corporate apparel",
    "WhatsApp private label",
    "WhatsApp Yiwu direct",
    "WhatsApp China factory",
    "WhatsApp apparel supplier",
    "WhatsApp Yiwu production",
    "WhatsApp sublimation order",
    "WhatsApp all-over print order",
  ],
