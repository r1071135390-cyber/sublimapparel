...
export const metadata: Metadata = buildPageMetadata({
  ...
  keywords: [
    ...
    "sublimation samples",
    "all-over print samples",
    "fabric samples apparel",
    "apparel sample request",
    "custom clothing samples",
    "free apparel samples",
    "sublimation fabric samples",
    "apparel swatches",
    "custom apparel sample kit",
    "polyester samples",
    "cotton samples",
    "DTG samples",
    "DTF samples",
    "sublimation color samples",
    "custom jersey samples",
    "custom hoodie samples",
    "team apparel samples",
    "bulk apparel samples",
    "factory sample request",
    "apparel material samples",
    "sublimation print samples",
    "fabric swatches request",
    "Yiwu factory samples",
    "B2B apparel samples",
    "factory samples",
    "apparel sample order",
    "MOQ 50 samples",
    "DDP samples shipping",
    "event apparel samples",
    "corporate apparel samples",
    "school apparel samples",
    "race apparel samples",
    "promotional apparel samples",
    "private label samples",
    "private label clothing samples",
    "wholesale apparel samples",
    "sublimation sample order",
    "all-over print sample order",
    "sample pricing apparel",
    "sample turnaround apparel",
    "apparel sample process",
  ],
});
