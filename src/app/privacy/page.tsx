...
export const metadata = buildPageMetadata({
  ...
  keywords: [
    "apparel manufacturer privacy",
    "custom apparel privacy policy",
    "B2B apparel privacy",
    "sublimation factory privacy",
    "all-over print privacy",
    "factory direct privacy policy",
    "Yiwu factory privacy",
    "apparel company privacy",
    "custom clothing privacy",
    "wholesale apparel privacy",
    "B2B clothing privacy",
    "apparel quote privacy",
    "sublimation privacy policy",
    "all-over print privacy policy",
    "factory direct privacy",
    "apparel manufacturer data privacy",
    "China factory privacy",
    "Yiwu supplier privacy",
    "apparel e-commerce privacy",
    "custom apparel data policy",
    "sublimation data privacy",
    "all-over print data privacy",
    "factory direct data policy",
    "apparel order privacy",
    "SublimApparel privacy",
    "apparel privacy policy",
    "custom apparel privacy",
    "MOQ privacy",
    "DDP privacy apparel",
    "bulk apparel privacy",
    "apparel data protection",
    "team apparel privacy",
    "event apparel privacy",
    "corporate apparel privacy",
    "private label privacy",
    "private label clothing privacy",
    "apparel cookie policy",
    "apparel data retention",
    "apparel GDPR policy",
    "apparel CCPA policy",
    "apparel data processing",
  ]
});
