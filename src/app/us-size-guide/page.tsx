...
export const metadata = buildPageMetadata({
    ...
    "polo shirt sizing",
    "jersey size chart",
    "apparel measurement guide",
    "custom clothing sizing",
    "bulk apparel sizing",
    "size chart template",
    "US apparel size guide",
    "US t-shirt size chart",
    "US clothing sizes",
    "US apparel sizing",
    "XS to 4XL sizing",
    "US men t-shirt sizes",
    "US women t-shirt sizes",
    "US unisex sizing",
    "size chart custom apparel",
    "US apparel measurement",
    "team apparel sizing",
    "corporate apparel sizing",
    "US hoodies sizing",
    "US polo sizing",
    "US jersey sizing",
    "size guide factory direct",
    "US apparel fit guide",
    "US bulk sizing",
    "Yiwu factory US sizing",
    "US apparel manufacturer sizing",
    "US B2B apparel sizing",
    "apparel size conversion US",
    "custom apparel sizing",
    "B2B apparel sizing",
    "US hoodie size chart",
    "US jersey size chart",
    "US polo size chart",
    "sublimation apparel sizing",
    "all-over print sizing",
    "team uniform sizing",
    "athletic apparel sizing",
    "US men's sizing custom apparel",
    "US women's sizing custom apparel",
    "US youth sizing custom apparel",
    "US size conversion chart",
    "international size conversion",
    "size guide custom clothing",
    "how to measure for custom apparel",
    "apparel fit guide",
    "custom apparel fit chart",
    "US apparel measurement chart",
    "bulk apparel sizing guide",
  ],
    alternates: {
