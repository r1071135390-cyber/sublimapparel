...
export const metadata = buildPageMetadata({
    ...
    "sublimated cycling kit",
    "cycling team jerseys",
    "club cycling kit",
    "custom cycling bib shorts",
    "cycling race jerseys",
    "cycling team uniform",
    "cycling club kit",
    "bicycle team apparel",
    "cycling event shirts",
    "charity ride jerseys",
    "cycling team merch",
    "cycling sponsor jerseys",
    "cycling apparel bulk",
    "cycling team kit custom",
    "race day cycling apparel",
    "custom cycling kits",
    "sublimated cycling jerseys",
    "cycling apparel manufacturer",
    "cycling jersey factory",
    "cycling bib shorts custom",
    "cycling kit supplier",
    "cycling uniform manufacturer",
    "custom cycling clothing",
    "cycling team clothing",
    "cycling race apparel",
    "cycling jersey printing",
    "cycling apparel B2B",
    "cycling kit B2B",
    "cycling apparel factory",
    "cycling clothing factory",
    "cycling jersey sublimation",
    "custom cycling gear",
    ...
    <main>
        ...
        <div className="mx-auto grid max-w-7xl gap-0 px-6 md:grid-cols-12">
          <div className="md:col-span-7 py-16 md:py-24">
            ...
            <h1 className="text-5xl font-black leading-[0.95] tracking-tight md:text-8xl">
              ...
              sublimation
              <br />
              <span className="text-[#cc3d00]">cycling.</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link href="/industries/endurance-race-events/" className="inline-flex items-center gap-2 border-2 border-black bg-white px-6 py-3 text-sm font-black uppercase tracking-widest text-black transition-all hover:bg-black hover:text-white">
                See Cycling Cases
              </Link>
            </div>
          </div>
          <div className="md:col-span-5 border-t-2 border-black md:border-l-2 md:border-t-0 bg-[#0a0a0a] flex items-center justify-center p-10">
            <div className="text-center">
              <Bike className="mx-auto h-24 w-24 text-[#cc3d00] md:h-32 md:w-32" strokeWidth={1.5} />
      ...
      <section className="border-b-2 border-black bg-white">
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          ...
          <h2 className="text-4xl font-black leading-tight md:text-6xl">From race-cut to <span className="text-[#cc3d00]">padded bibs.</span></h2>
      ...
      <section className="border-b-2 border-black bg-[#faf9f6]">
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          ...
          <h2 className="text-4xl font-black leading-tight md:text-6xl">Italian. <span className="text-[#cc3d00]">Peloton-grade.</span></h2>
      ...
      <section className="border-b-2 border-black bg-white">
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          ...
          <h2 className="text-4xl font-black leading-tight md:text-6xl">Team kit. <span className="text-[#cc3d00]">Built your way.</span></h2>
      ...
      <section className="border-b-2 border-black bg-[#0a0a0a] text-white">
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          ...
          <h2 className="text-4xl font-black leading-tight md:text-6xl">From <span className="text-[#cc3d00]">peloton</span> to back of pack.</h2>
          <div className="mt-10 grid gap-0 md:grid-cols-2 lg:grid-cols-3">
            {useCases.map((u, i) => (
          ...
          <div className="mt-10 border-2 border-black bg-white">
            ...
            {pricing.map((p, i) => (
              <div key={p.qty} className={`grid grid-cols-12 text-sm ${i < pricing.length - 1 ? "border-b-2 border-black" : ""}`}>
                ...
                <div className="col-span-3 border-r-2 border-black p-3 font-black text-[#cc3d00]">{p.shorts}</div>
