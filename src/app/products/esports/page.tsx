...
export const metadata = buildPageMetadata({
    ...
    "gaming team apparel",
    "esports team merch",
    "esports club apparel",
    "esports event apparel",
    "gaming team uniform",
    "esports sponsor shirts",
    "esports pro team kit",
    "esports merchandise",
    "esports league apparel",
    "streaming team apparel",
    "gaming event shirts",
    "esports apparel bulk",
    "esports apparel manufacturer",
    "esports jersey factory",
    "esports uniform supplier",
    "sublimated esports jerseys",
    "esports team uniform",
    "esports jersey printing",
    "esports clothing custom",
    "esports team clothing",
    "gaming jersey custom",
    "gaming apparel factory",
    "esports league jerseys",
    "gaming club apparel",
    "esports tournament jerseys",
    "esports team kit",
