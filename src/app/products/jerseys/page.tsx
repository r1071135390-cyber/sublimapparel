...
export const metadata = buildPageMetadata({
    ...
    "team jersey design",
    "league jersey supplier",
    "custom athletic jerseys",
    "jersey printing bulk",
    "team uniform jerseys",
    ...
    "custom jersey factory",
    "sublimation jersey supplier",
    "team jerseys custom",
    "event jerseys custom",
    "sports jerseys custom",
    "school jerseys custom",
    "promotional jerseys",
    "private label jerseys",
    "B2B jersey supplier",
    "bulk jersey manufacturer",
    "custom jersey printing",
    "MOQ jerseys",
    "jersey factory direct",
    "jersey wholesale supplier",
...
export default function JerseysPage() {
  ...
  const categoryGraph = buildCategoryProductGraph({
    slug: "jerseys",
    path: "/products/jerseys/",
    name: "Custom Team Jerseys",
    description:
      "Custom sublimation team jerseys for soccer, baseball, basketball, volleyball. All-over print, MOQ 50 pcs, DDP shipping worldwide.",
    productCategory: "Team Jersey",
    mpn: "SA-JRS-01",
