...
export const metadata = buildPageMetadata({
    ...
    "sublimation t-shirt supplier",
    "team t-shirts custom",
    "event t-shirts custom",
    "corporate t-shirts custom",
    "school t-shirts custom",
    "promotional t-shirts",
    "private label t-shirts",
    "B2B t-shirt supplier",
    "bulk t-shirt manufacturer",
    "custom t-shirt printing",
    "MOQ t-shirts",
    "t-shirt factory direct",
    "t-shirt wholesale supplier",
    "custom cotton t-shirts",
    "custom polyester t-shirts",
    "custom heavyweight t-shirts",
