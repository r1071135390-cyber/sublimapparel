...
export const metadata = buildPageMetadata({
    ...
    "sublimated training wear",
    "gym training shirts",
    "fitness team apparel",
    "training team uniform",
    "athletic training wear",
    "gym team shirts",
    "crossfit team apparel",
    "training camp shirts",
    "fitness club apparel",
    "athletic club apparel",
    "training sponsor shirts",
    "fitness event apparel",
    "training merch",
    "training day apparel",
    "performance training shirts",
    "training program apparel",
    "fitness program shirts",
    "training team apparel",
    "training jersey custom",
    "sublimated training apparel",
    "training singlet custom",
    "training shirt custom",
    "training apparel manufacturer",
    "training apparel factory",
    "custom training gear",
    "training uniform supplier",
    "training team clothing",
    "training apparel B2B",
    "training shirt printing",
    "training singlet factory",
    "training club apparel",
    "training league apparel",
    "training event apparel",
    "training gym apparel",
    "training fitness apparel",
    "custom training clothing",
  ...
  return (
    <main>
      ...
      {/* 2026-09-18 (R73 GEO): Direct Answer block — AI engines
          see "custom training apparel" in the first DOM pass. */}
      <PageGeoAnswerBlock path="/products/training-apparel/" />
