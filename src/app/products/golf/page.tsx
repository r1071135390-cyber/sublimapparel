...
export const metadata = buildPageMetadata({
    ...
    "golf outing shirts",
    "golf charity event apparel",
    "golf pro shop apparel",
    "golf team kit",
    "golf merchandise",
    "golf apparel bulk",
    "tournament golf polo",
    "golf team apparel",
    "golf polo manufacturer",
    "golf polo factory",
    "golf apparel B2B",
    "golf team uniforms",
    ...
    "golf custom apparel",
    "golf polo printing",
    "golf apparel factory",
    "golf clothing factory",
    "golf polo sublimation",
    "custom golf clothing",
    "golf merchandise apparel",
    "golf event apparel",
...
export default function GolfPage() {
  ...
  const categoryGraph = buildCategoryProductGraph({
    slug: "golf",
    path: "/products/golf/",
    name: "Custom Golf Apparel",
    description:
      "Custom sublimation golf apparel — polos, mock necks, quarter-zips, long sleeve. MOQ 50 pcs, DDP shipping worldwide.",
    productCategory: "Golf Polo",
    mpn: "SA-GLF-01",
        ...
        <div className="mx-auto grid max-w-7xl gap-0 px-6 md:grid-cols-12">
          <div className="md:col-span-7 py-16 md:py-24">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link href="/industries/corporate-employee-programs/" className="inline-flex items-center gap-2 border-2 border-black bg-white px-6 py-3 text-sm font-black uppercase tracking-widest text-black transition-all hover:bg-black hover:text-white">
                See Club Cases
              </Link>
            </div>
          </div>
