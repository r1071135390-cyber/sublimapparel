...
export const metadata = buildPageMetadata({
    ...
    "charity run shirts",
    "club running kit",
    "sublimated running apparel",
    "marathon shirts",
    "race running shirts",
    "running team shirts",
    "running club apparel",
    "5k race shirts",
    "10k running shirts",
    "half marathon shirts",
    "running event shirts",
    "running team uniform",
    "athletic running shirts",
    "cross country shirts",
    "running merch",
    "running singlet custom",
    "running tank tops custom",
    "running sponsor shirts",
    "running club kit",
    "running team apparel",
    "running jersey custom",
    "sublimated running shirts",
    "running team jersey",
    "marathon shirt custom",
    "running apparel manufacturer",
    "running shirt factory",
    "custom running gear",
    "running uniform supplier",
    "running apparel B2B",
    "running shirt printing",
    "running singlet factory",
    "marathon apparel custom",
    "race running apparel",
    "running league apparel",
    "running event apparel",
    "running team clothing",
