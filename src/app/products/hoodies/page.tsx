...
export const metadata = buildPageMetadata({
    ...
    "athletic hoodies custom",
    "personalized hoodies",
    "bulk hoodie printing",
    "hoodie for team",
    "custom hoodie manufacturer",
    "custom hoodie factory",
    "sublimation hoodie supplier",
    "team hoodies custom",
    "event hoodies custom",
    "corporate hoodies custom",
    "school hoodies custom",
    "promotional hoodies",
    "private label hoodies",
    "B2B hoodie supplier",
    "bulk hoodie manufacturer",
    "MOQ hoodie",
    "hoodie factory direct",
    "hoodie wholesale supplier",
...
export default function HoodiesPage() {
  ...
  const categoryGraph = buildCategoryProductGraph({
    ...
    description:
      "Custom sublimation hoodies — pullover, zip-up, cropped, heavyweight. All-over print, MOQ 50 pcs, DDP shipping worldwide.",
  ...
  return (
    <main>
      ...
      {/* 2026-09-18 (R73 GEO): Direct Answer block — AI engines
          see "custom hoodies and sweatshirts" in the first DOM pass. */}
      <PageGeoAnswerBlock path="/products/hoodies/" />
