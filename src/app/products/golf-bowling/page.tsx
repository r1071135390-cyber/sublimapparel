...
import { ArrowRight, Flag, Users, Palette, Ruler, Layers, Shirt } from "lucide-react";

export const metadata: Metadata = {
  title: "Custom Golf & Bowling Apparel | Sublimated Polos, Mock Necks, Quarter-Zips | SublimApparel",
  description:
    "Premium custom golf polos, mock necks, and bowling jerseys. Sublimated all-over print, moisture-wicking polyester-spandex, 4-way stretch. Country clubs, tournaments, corporate golf days, bowling leagues. MOQ 50 pcs.",
  keywords: [
    "golf apparel",
    "golf shirts",
    ...
    "bowling jersey",
    "bowling shirt",
    "sublimation golf wear",
    "country club uniform",
    "corporate golf day",
    "all over print polo",
    "tournament golf apparel",
  ],
};
...
const styles = [
  ...
  { name: "Mock Neck", desc: "No collar, hidden zip, modern athletic cut. Tournaments, pro-shop retail, tech-forward country clubs.", gsm: "180–200 GSM" },
  ...
  { name: "Long Sleeve Polo", desc: "Cool-weather rounds, Bandon Dunes-style. Same placket, heavier weight.", gsm: "200–220 GSM" },
  { name: "Women's Sleeveless", desc: "Racerback or cap-sleeve polo, golf-specific women's cut. Slightly longer in back.", gsm: "180–200 GSM" },
  { name: "Bowling Jersey", desc: "Looser fit, contrasting side panels, name/number front and back. League nights, tournaments, retro style.", gsm: "160–180 GSM" },
];
...
const fabricChoices = [
  ...
  { name: "Recycled Poly (rPET)", best: "Eco-aware clubs · sustainability story", moq: "100 pcs" },
...
const customisation = [
  ...
  { icon: Flag, title: "Tournament-ready", desc: "Sponsor panels on sleeves and back yoke. Easy to swap sponsor per event." },
...
const useCases = [
  ...
  { who: "Bowling leagues & centres", what: "League nights, tournaments, retro style, sponsor panels" },
...
const faq = [
  ...
  {
    q: "Can you make bowling shirts?",
    a: "Yes — and they're one of our fastest-growing categories. The retro style with contrasting side panels and name/number on the back is popular with both classic leagues and modern boutique bowling centres.",
  },
  {
...
export default function GolfBowlingPage() {
  return (
    <main>
      <JsonLd data={{
        "@context": "https://schema.org",
        "@type": "Product",
        "name": "Custom Golf & Bowling Apparel",
        ...
        "offers": {
          "@type": "Offer",
          "url": `${process.env.NEXT_PUBLIC_SITE_URL || "https://sublimapparel.com"}/products/golf-bowling/`,
          "priceCurrency": "USD",
          "priceRange": "$",
        ...
        <div className="mx-auto grid max-w-7xl gap-0 px-6 md:grid-cols-12">
          <div className="md:col-span-7 py-16 md:py-24">
            ...
            <h1 className="text-5xl font-black leading-[0.95] tracking-tight md:text-8xl">
              ...
              Custom bowling.
              <br />
              <span className="text-[#ff4d00]">Custom everything.</span>
            </h1>
            <p className="mt-6 max-w-xl text-base text-neutral-700 md:text-lg">
              Sublimated polos, mock necks, quarter-zips and bowling jerseys for country clubs, tournaments, corporate golf days and bowling leagues. Poly-spandex 4-way stretch, swing-friendly, anti-wrinkle. At factory-direct pricing.
            </p>
          ...
          <div className="md:col-span-5 border-t-2 border-black md:border-l-2 md:border-t-0 bg-[#0a0a0a] flex items-center justify-center p-10">
            <div className="text-center">
              ...
              <p className="mt-4 text-xs font-bold uppercase tracking-widest text-white">Country Clubs · Tournaments</p>
              <p className="mt-1 text-xs font-bold uppercase tracking-widest text-white">Bowling Leagues · Corporate</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="border-b-2 border-black bg-white">
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          ...
          <h2 className="text-4xl font-black leading-tight md:text-6xl">From <span className="text-[#ff4d00]">classic polo</span> to quarter-zip.</h2>
          <p className="mt-4 max-w-2xl text-base text-neutral-700 md:text-lg">The full range of golf and bowling tops — all sublimation-ready.</p>
      ...
      <section className="border-b-2 border-black bg-[#faf9f6]">
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          ...
          <h2 className="text-4xl font-black leading-tight md:text-6xl">Swing-friendly. <span className="text-[#ff4d00]">Sweat-free.</span></h2>
          <p className="mt-4 max-w-2xl text-base text-neutral-700 md:text-lg">All fabrics are poly or poly-spandex — we never use cotton for golf or bowling performance wear.</p>
      ...
      <section className="border-b-2 border-black bg-[#0a0a0a] text-white">
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          ...
          <h2 className="text-4xl font-black leading-tight md:text-6xl">From <span className="text-[#ff4d00]">the 1st tee</span> to the 10th frame.</h2>
          <div className="mt-10 grid gap-0 md:grid-cols-2 lg:grid-cols-3">
            {useCases.map((u, i) => (
          ...
          <div className="mt-10 border-2 border-black bg-white">
            ...
            {pricing.map((p, i) => (
              <div key={p.qty} className={`grid grid-cols-12 text-sm ${i < pricing.length - 1 ? "border-b-2 border-black" : ""}`}>
                ...
                <div className="col-span-3 border-r-2 border-black p-3 font-black text-[#ff4d00]">{p.quarter}</div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 md:py-28">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="/get-a-quote" className="group inline-flex items-center gap-2 bg-black px-6 py-3 text-sm font-black uppercase tracking-widest text-white transition-all hover:bg-white hover:text-[#ff4d00]">
              Get a Golf / Bowling Quote <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" strokeWidth={2.5} />
            </Link>
