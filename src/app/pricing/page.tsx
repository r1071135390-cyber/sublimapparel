...
export const metadata: Metadata = buildPageMetadata({
  ...
  keywords: [
    ...
    "apparel manufacturing cost",
    "clothing factory pricing",
    "bulk apparel pricing",
    "sublimation print cost",
    "custom clothing price",
    "wholesale apparel pricing",
    "apparel production cost",
    "MOQ 50 pricing",
    "DDP shipping cost",
    "sublimation apparel pricing",
    "factory direct pricing",
    "apparel quote",
    "custom apparel cost",
    "sublimation pricing",
    "all-over print pricing",
    "B2B apparel pricing",
    "apparel manufacturer pricing",
    "factory pricing apparel",
    "bulk order pricing",
    "sublimation cost",
    "all-over print cost",
    "DTG pricing apparel",
    ...
    "team apparel pricing",
    "event apparel pricing",
    "corporate apparel pricing",
    "apparel quote online",
    "DDP shipping pricing",
    "Yiwu factory pricing",
    "custom clothing pricing",
    "sublimation factory pricing",
    "apparel cost breakdown",
    "apparel cost guide",
    "apparel cost calculator",
    "school apparel pricing",
    "race apparel pricing",
    "promotional apparel pricing",
    "private label pricing",
    "private label clothing pricing",
    "apparel manufacturing pricing",
  ],
});
