...
export const metadata = buildPageMetadata({
    ...
    "custom clothing deadline",
    "apparel order planning",
    "fast track custom apparel",
    "B2B apparel production calendar",
    "apparel manufacturing program",
    "custom apparel rush order",
    "90-day custom apparel program",
    "rapid apparel production",
    "90-day clothing program",
    "quick turn apparel manufacturer",
    "fast fashion manufacturing",
    "rapid prototyping apparel",
    "fast custom apparel",
    "accelerated apparel program",
    "express custom clothing",
    "rush order apparel",
    "quick turn clothing factory",
    "rapid sampling apparel",
    "fast track clothing program",
    "30 day apparel production",
    "60 day apparel production",
    "rush team apparel",
    "fast event apparel",
    "accelerated clothing manufacturing",
    "rapid clothing sampling",
    "express clothing factory",
    "rush order clothing",
    "fast custom clothing",
    "90-day production program",
    "fast turnaround custom apparel",
    "rush apparel production",
    "express custom apparel",
    "90-day apparel program",
    "fast fashion custom apparel",
    "rapid custom clothing",
    "express apparel manufacturing",
    "rush order custom apparel",
    "express team apparel",
    "express event apparel",
    "express corporate apparel",
    "90-day B2B apparel",
    "90-day factory program",
    "fast production custom clothing",
    "90-day apparel service",
    "expedited custom apparel",
    "quick custom apparel",
    "express private label apparel",
    "90-day promo apparel",
    "rush sublimation apparel",
    "90-day all-over print program",
  ],
    alternates: {
