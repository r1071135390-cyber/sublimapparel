...
export const metadata: Metadata = buildPageMetadata({
  ...
  keywords: [
    ...
    "sublimation print durability",
    "how to care for custom apparel",
    "sublimation fabric care",
    "DTG care instructions",
    "all-over print care",
    "sublimated t-shirt washing",
    "sublimation fabric care guide",
    "custom apparel care instructions",
    "how to wash all-over print",
    "polyester fabric care",
    "cotton apparel care instructions",
    "printed apparel care",
    "garment care sublimated",
    "athletic apparel care",
    "custom clothing care guide",
    "fabric care symbols",
    "how to care sublimation",
    "wash sublimated t-shirts",
    "fabric care instructions apparel",
    "clothing care custom",
    "apparel fabric care",
    "print care instructions",
    "garment care symbols",
    "sublimation wash care",
  ],
