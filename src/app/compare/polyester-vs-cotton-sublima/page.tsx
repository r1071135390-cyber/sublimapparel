...
export const metadata: Metadata = buildPageMetadata({
  ...
  keywords: [
    ...
    "all-over print fabric choice",
    "sublimation vs DTG cotton",
    "apparel fabric for sublimation",
    "polyester cotton comparison",
    "sublimation print fabric",
    "100% cotton sublimation",
    "polyester print quality",
    "sublimation polyester cotton comparison",
    "polyester vs cotton apparel",
    "cotton sublimation vs polyester sublimation",
    "all-over print polyester cotton",
    "which fabric for sublimation",
    "polyester cotton print comparison",
    "sublimation fabric choice",
    "polyester vs cotton custom apparel",
    "best fabric sublimation",
    "polyester vs cotton printing",
    "sublimation polyester cotton",
    "polyester sublimation vs DTG cotton",
    "polyester cotton fabric comparison",
    "sublimation cotton printing",
    "DTG vs sublimation fabric",
    "polyester vs cotton hand feel",
    "polyester cotton durability",
    "polyester cotton color vibrancy",
    "polyester vs cotton cost",
    "polyester vs cotton MOQ",
    "polyester cotton all-over print",
    "sublimation on cotton",
    "sublimation on polyester",
    "cotton vs polyester for sublimation",
    "100% cotton vs 100% polyester",
    "polyester sublimation vs cotton sublimation",
    "cotton sublimation comparison",
    "polyester sublimation comparison",
    "best fabric for sublimation",
    "polyester vs cotton feel",
    "polyester vs cotton comfort",
    "polyester vs cotton durability",
    "polyester vs cotton turnaround",
    "polyester vs cotton moisture wicking",
    "polyester vs cotton breathability",
    "polyester vs cotton B2B",
    "polyester vs cotton factory",
    "cotton sublimation DTG DTF",
    "polyester vs cotton all-over print",
    "polyester vs cotton race apparel",
    "polyester vs cotton team uniform",
    "polyester vs cotton marathon shirt",
  ],
});
