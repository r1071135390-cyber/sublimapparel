...
export const metadata: Metadata = buildPageMetadata({
  ...
  keywords: [
    ...
    "screen printing vs sublimation cost",
    "sublimation vs screen print color",
    "custom apparel print method",
    "bulk print method choice",
    "print durability comparison",
    "screen print vs sublimation MOQ",
    "sublimation screen print comparison",
    "which is better sublimation or screen print",
    "sublimation screen print quality",
    "screen print vs sublimation fabric",
    "sublimation vs screen print for small business",
    "sublimation vs screen print for large orders",
    "screen printing sublimation durability",
    "screen print vs sublimation color",
    "sublimation vs screen print MOQ",
    "sublimation screen print for apparel",
    "screen printing sublimation comparison",
    "sublimation vs screen print hand feel",
    "which print method screen sublimation",
    "sublimation screen print sample",
    "sublimation vs screen print for ecommerce",
    "screen print sublimation setup fee",
    "sublimation vs screen print bulk",
    "screen printing sublimation for teams",
    "sublimation screen print for events",
    "screen print sublimation pros cons",
    "sublimation vs screen print comparison",
    "sublimation vs screen print quality",
    "sublimation vs screen print cost",
    "sublimation vs screen print design",
    "sublimation vs screen print all-over",
    "sublimation vs screen print detail",
    "sublimation vs screen print durability",
    "sublimation vs screen print turnaround",
    "sublimation vs screen print small batch",
    "sublimation vs screen print fabric",
    "sublimation vs screen print polyester",
    "sublimation vs screen print cotton",
    "sublimation vs screen print B2B",
    "sublimation vs screen print factory",
    "sublimation vs screen print pros cons",
    "sublimation vs screen print apparel",
    "sublimation vs screen print custom",
    "sublimation vs screen print team uniform",
