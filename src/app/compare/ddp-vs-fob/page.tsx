...
export const metadata: Metadata = buildPageMetadata({
  ...
  keywords: [
    ...
    "DDP shipping USA",
    "FOB shipping apparel",
    "import duty customs",
    "apparel shipping terms",
    "DDP to door shipping",
    "China apparel import",
    "apparel logistics terms",
    "DDP vs FOB comparison",
    "which is better DDP or FOB",
    "DDP shipping explained",
    "FOB shipping explained",
    "import shipping DDP FOB",
    "DDP FOB difference",
    "DDP vs FOB for small business",
    "DDP vs FOB cost",
    "DDP vs FOB pros cons",
    "China shipping DDP FOB",
    "DDP FOB decision guide",
    "apparel shipping DDP FOB",
    "import duty DDP FOB",
    "DDP vs FOB custom apparel",
    "FOB DDP comparison chart",
    "DDP FOB which to choose",
    "first time importer DDP FOB",
    "DDP vs FOB bulk apparel",
    "DDP FOB for Amazon FBA",
    "DDP FOB Shopify brands",
    "DDP FOB for e-commerce",
    "DDP FOB clothing import",
    "DDP FOB textile shipping",
    "delivered duty paid vs free on board",
    "DDP vs FOB for Amazon FBA",
    "DDP vs FOB cost comparison",
    "DDP vs FOB customs clearance",
    "DDP vs FOB tariff paid",
    "DDP vs FOB shipping apparel",
    "DDP vs FOB bulk shipping",
    "DDP vs FOB international shipping",
    "DDP vs FOB which is better",
    "DDP vs FOB for Shopify brands",
    "DDP vs FOB startup shipping",
    "DDP vs FOB B2B shipping",
    "DDP vs FOB shipping guide",
    "DDP vs FOB clothing import",
    "DDP vs FOB apparel import",
    "DDP vs FOB from China",
    "DDP vs FOB Yiwu shipping",
    "DDP vs FOB buyer responsibilities",
    "DDP vs FOB seller responsibilities",
    "DDP vs FOB landed cost",
  ],
});
...
const faqId = "https://sublimapparel.com/compare/ddp-vs-fob/#faq";
const webpageId = "https://sublimapparel.com/compare/ddp-vs-fob/#webpage";
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white text-black">
        {/* 2026-09-18 (R73 GEO): AI-crawler Direct Answer block at the very top
            of <main> so Perplexity / ChatGPT Search / Gemini can lift a
            stable 60-word answer before they hit the visual hero. */}
        <PageGeoAnswerBlock path="/compare/ddp-vs-fob/" />
          ...
          <div className="mx-auto max-w-6xl px-6">
            ...
            <div className="mt-8 overflow-x-auto">
              {/* 2026-09-11 (R21-B): explicit Schema.org Table markup so Google
                  ...
                  direct answer for "DDP vs FOB" PAA queries. */}
              <table
                itemScope
