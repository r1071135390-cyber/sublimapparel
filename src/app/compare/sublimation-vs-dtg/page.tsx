...
export const metadata: Metadata = buildPageMetadata({
  ...
  // 160-char SERP cap.
  description:
    "Sublimation vs DTG for custom apparel: cost, color vibrancy, fabric compatibility, MOQ, hand feel, and durability. Which one fits your order?",
  ...
  keywords: [
    ...
    "B2B print method",
    "DTG vs sublimation quality",
    "apparel print method",
    "all-over print vs DTG",
    "sublimation vs DTG fabric",
    "custom print method",
    "print cost per piece",
    "DTG vs sublimation MOQ",
    "sublimation DTG comparison",
    "DTG vs sublimation",
    "which is better sublimation or DTG",
    "DTG sublimation quality",
    "DTG vs sublimation fabric",
    "sublimation vs DTG for cotton",
    "sublimation vs DTG for polyester",
    "DTG vs sublimation color",
    "sublimation vs DTG durability",
    "sublimation DTG for small business",
    "DTG sublimation apparel",
    "polyester sublimation vs cotton DTG",
    "DTG vs dye sublimation",
    "sublimation DTG printing",
    "which print method sublimation DTG",
    "DTG sublimation for small orders",
    "DTG vs sublimation hand feel",
    "sublimation DTG sample",
    "sublimation vs DTG MOQ",
    "DTG sublimation for ecommerce",
    "DTG sublimation for custom apparel",
    "sublimation vs DTG printing",
    "DTG vs sublimation comparison",
    "sublimation vs DTG quality",
    "sublimation vs DTG cost",
    "sublimation vs DTG polyester",
    "sublimation vs DTG cotton",
    "sublimation vs DTG all-over print",
    "sublimation vs DTG color",
    "sublimation vs DTG turnaround",
    "sublimation vs DTG bulk",
    "sublimation vs DTG small batch",
    "sublimation vs DTG factory",
    "sublimation vs DTG B2B",
    "DTG vs sublimation which is better",
    "sublimation vs DTG pros cons",
    "sublimation vs DTG apparel",
    "DTG vs sublimation custom clothing",
    "sublimation vs DTG sportswear",
    "DTG vs sublimation polyester cotton",
    "sublimation vs DTG guide",
  ],
});
