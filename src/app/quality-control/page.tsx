...
export const metadata = buildPageMetadata({
    ...
    "apparel defect rate",
    "custom clothing quality",
    "apparel manufacturing QC",
    "in-line inspection apparel",
    "custom apparel QC",
    "sublimation QC",
    "all-over print quality",
    "clothing quality standards",
    "apparel inspection process",
    "QC inspection apparel",
    "AQL 2.5 apparel",
    "apparel defect prevention",
    "factory QC apparel",
    "99.2% first pass quality",
    "4-stage inspection",
    "sublimation quality assurance",
    "apparel sample QC",
    "garment QC process",
    "apparel production QC",
    "clothing quality control",
    "QC standards apparel",
    "apparel manufacturer QC",
    "sublimation print QC",
    "apparel bulk order QC",
    "apparel color accuracy QC",
    "apparel sizing QC",
    "AQL 2.5 quality standard",
    "apparel quality assurance",
    "apparel QC standards",
    "4-stage inspection apparel",
    "garment QC standards",
    "apparel quality testing",
    "apparel inspection report",
    "apparel QC documentation",
    "sublimation QC standards",
    "apparel quality guarantee",
    "apparel QC process",
    "apparel QC best practices",
    "apparel manufacturer quality",
    "apparel QC transparency",
  ],
    alternates: {
