...
export const techniques: Technique[] = [
  {
    ...
    metaTitle: "Sublimation Printing | All-Over Print Apparel",
    metaDescription:
...
"Event staff uniforms and brand activation wear",
...

  {
    ...
    metaTitle: "Custom Screen Printing | Plastisol & Water-Based Inks",
    metaDescription:
...
"School and university merchandise",
...

  {
    ...
    metaTitle: "Custom Logo Embroidery | 3D Puff & Flat Stitch",
    metaDescription:
...
"Hotel, restaurant and service industry staff apparel",
...

  {
    ...
    shortName:"DTG",
    metaTitle: "Direct to Garment (DTG) Printing | Cotton Apparel",
    metaDescription:
...
"Limited edition drops and exclusive collections",
...

  {
    ...
    shortName:"DTF",
    metaTitle: "DTF Transfers | Direct to Film | Cotton, Polyester & Blends",
    metaDescription:
...
"Small to medium custom runs",
...

  {
    ...
    shortName:"3D Puff",
    metaTitle: "3D Puff Embroidery | Foam-Raised Logo | Caps & Streetwear",
    metaDescription:
...
"Trucker caps and snapback collections",
...

  {
    ...
    metaTitle: "Rhinestone Heat Press Apparel | Custom Bling",
    metaDescription:
...
"Bridal party and bachelorette apparel",
...

  {
    ...
    shortName:"Metallic",
    metaTitle: "Metallic Printing | Gold & Silver Foil Apparel",
    metaDescription:
...
"Statement streetwear and hype drops",
...

  {
    ...
    metaTitle: "Reflective Printing | High-Vis Safety Apparel",
    metaDescription:
...
"Limited edition hype streetwear with safety aesthetic",
...

  {
    ...
    shortName:"Flocking",
    metaTitle: "Flocking Printing | Velvety Raised Print",
    metaDescription:
...
"Special event merchandise and awards",
...

  {
    ...
    shortName:"Glitter",
    metaTitle: "Glitter Printing | Sparkle Finish Apparel",
    metaDescription:
...
"Cosplay and costume design",
...

  {
    ...
    shortName:"Silicone",
    metaTitle: "Silicone Heat Transfer Printing | 3D Rubber Print",
    metaDescription:
...
"Premium corporate and team apparel",
...

  {
    ...
    shortName:"Embossing",
    metaTitle: "Embossing & Debossing | Raised & Recessed Designs",
    metaDescription:
...
"Genuine leather and vegan leather goods",
...

  {
    ...
    shortName:"Applique",
    metaTitle: "Applique Embroidery | Sewn-On Fabric Patches",
    metaDescription:
...
"Statement hype and limited edition drops",
...

  {
    ...
    shortName:"Beaded",
    metaTitle: "Beaded Embroidery | Custom Bead Work",
    metaDescription:
...
"Performance costumes and competition wear",
...

  {
    ...
    shortName:"Terry",
    metaTitle: "Terry Chenille Embroidery | Varsity Lettering",
    metaDescription:
...
"Throwback athletic and 90s-inspired designs",
...

  {
    ...
    shortName:"Yarn",
    metaTitle: "Yarn Embroidery | Custom Stitch Patterns",
    metaDescription:
...
"Heritage and rustic branding",
...

  {
    ...
    metaTitle: "All-Over Sublimation Printing | Full Coverage Apparel",
    metaDescription:
...
"Event staff uniforms and brand activation wear",
...

  {
    ...
    shortName:"Laser",
    metaTitle: "Laser Engraving Apparel | Permanent Mark",
    metaDescription:
...
"Eco-friendly and sustainable collections",
...

  {
    ...
    metaTitle: "3D Embroidery | Foam-Raised Stitching",
    metaDescription:
