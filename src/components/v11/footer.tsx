        ...
        <div className="mb-12 grid gap-12 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/80">
              <li><Link href="/v11/products" className="hover:text-white">Custom T-Shirts</Link></li>
              <li><Link href="/v11/products" className="hover:text-white">Sports Jerseys</Link></li>
              <li><Link href="/v11/products" className="hover:text-white">Hoodies</Link></li>
              <li><Link href="/v11/products" className="hover:text-white">All categories</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/80">
              <li><Link href="/v11/about" className="hover:text-white">About us</Link></li>
              <li><Link href="/v11/contact" className="hover:text-white">Contact</Link></li>
              <li><Link href="/v11/contact" className="hover:text-white">Get a quote</Link></li>
            </ul>
          </div>
